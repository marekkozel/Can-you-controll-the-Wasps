...
var audio_manager_path: String = "res://Scenes/Audio_managment/audio_manager.tscn" ## The path to the audio manager scene.
var audio_manage_scene: PackedScene = load(audio_manager_path) ## Loads the audio manage scene so the tool can modify it.
var folder_path: String = "res://Resources/Sounds/SFX/" ## The path to your folder containing your SoundEffect resources.
